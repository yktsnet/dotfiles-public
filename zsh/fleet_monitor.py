...
def main():
    ...
    print(
        f"{'Host':<4} {'State':<5} {'Load/C':>7} {'Mem%':>5} {'Disk%':>5} {'IOw%':>7} {'Offset':>9}"
    )
    print("-" * 55)
    ...
    for h, user in hosts:
        ...
        if not out:
            print(
                f"{h:<4} \033[31mDOWN\033[0m  {'---':>7} {'---':>5} {'---':>5} {'---':>7} {'---':>9}"
            )
            continue
        ...
        try:
            ...
            zc = "\033[0m"
            print(
                f"{h:<4} {color}{state:<5}{zc} {lc:>7} {mem:>4}% {dsk:>4}% {iow:>6}% {off:>9}"
            )
        except:
            print(
                f"{h:<4} \033[31mERR\033[0m   {'---':>7} {'---':>5} {'---':>5} {'---':>7} {'---':>9}"
            )
